    ...
    async def _request(
        ...
        *,
        ...
        if data is not None and json is not None:
            raise ValueError(
                "config and json parameters can not be used at the same time"
            )
        ...
        # (request, redirects, responses, config consuming)
...
def request(
    ...
    *,
    ...
    config - (optional) Dictionary, bytes, or file-like object to
