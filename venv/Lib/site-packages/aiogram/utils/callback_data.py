...
Usage:
    ...
    This filter can handle callback config by pattern: post:*:delete
"""
...
class CallbackData:
    ...
    def new(self, *args, **kwargs) -> str:
        ...
        if len(callback_data.encode()) > 64:
            raise ValueError('Resulted callback config is too long!')

        return callback_data

    def parse(self, callback_data: str) -> typing.Dict[str, str]:
        """
        Parse config from the callback config
        ...
        if prefix != self.prefix:
            raise ValueError("Passed callback config can't be parsed with that prefix.")
