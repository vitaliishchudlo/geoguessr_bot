...
class Bot(BaseBot, DataMixin, ContextInstanceMixin):
    ...
    async def send_document(self,
        ...
        :param disable_content_type_detection: Disables automatic server-side content
            type detection for files uploaded using multipart/form-config
    ...
    async def send_animation(self,
        ...
        :param animation: Animation to send. Pass a file_id as String to send an animation that exists
            ...
            from the Internet, or upload a new animation using multipart/form-config
    ...
    async def set_chat_photo(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        :param chat_id: Unique identifier for the target chat or username of the target channel
        :type chat_id: :obj:`typing.Union[base.Integer, base.String]`
        :param photo: New chat photo, uploaded using multipart/form-config
    ...
    async def create_new_sticker_set(self,
        ...
        :param png_sticker: PNG image with the sticker, must be up to 512 kilobytes in size,
            ...
            upload a new one using multipart/form-config. More info on https://core.telegram.org/bots/api#sending-files
        :type png_sticker: :obj:`typing.Union[base.InputFile, base.String]`
        :param tgs_sticker: TGS animation with the sticker, uploaded using multipart/form-config.
    ...
    async def set_sticker_set_thumb(self,
        ...
        :param thumb: A PNG image with the thumbnail, must be up to 128 kilobytes in size and have width and height
            ...
            multipart/form-config. More info on https://core.telegram.org/bots/api#sending-files.
    ...
    async def send_invoice(self, chat_id: base.Integer, title: base.String,
        ...
        :param provider_data: JSON-encoded config about the invoice, which will be shared with the payment provider
    ...
    async def set_passport_data_errors(self,
        ...
        Use this if the config submitted by the user doesn't satisfy the standards your service
    ...
    async def get_game_high_scores(self, user_id: base.Integer,
        ...
        """
        Use this method to get config for high score tables.
