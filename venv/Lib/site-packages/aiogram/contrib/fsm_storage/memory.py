...
class MemoryStorage(BaseStorage):
    ...
    def resolve_address(self, chat, user):
        ...
        if user_id not in self.data[chat_id]:
            self.data[chat_id][user_id] = {'state': None, 'config': {}, 'bucket': {}}
    ...
    async def get_data(self, *,
        ...
        chat, user = self.resolve_address(chat=chat, user=user)
        return copy.deepcopy(self.data[chat][user]['config'])
    ...
    async def update_data(self, *,
        ...
        if data is None:
            data = {}
        chat, user = self.resolve_address(chat=chat, user=user)
        self.data[chat][user]['config'].update(data, **kwargs)
    ...
    async def set_data(self, *,
        ...
        chat, user = self.resolve_address(chat=chat, user=user)
        self.data[chat][user]['config'] = copy.deepcopy(data)
