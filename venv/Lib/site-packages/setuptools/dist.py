...
def write_pkg_file(self, file):  # noqa: C901  # is too complex (14)  # FIXME
    """Write the PKG-INFO format config to a file object.
    """
...
class Distribution(_Distribution):
    """Distribution with support for tests and package config
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'package_data' -- a dictionary mapping package names to lists of filenames
        or globs to use to find config files contained in the named packages.
    ...
    def patch_missing_pkg_info(self, attrs):
        # Fake up a replacement for the config that would normally come from
    ...
    def _parse_config_files(self, filenames=None):  # noqa: C901
        ...
        ignore_options = [] if sys.prefix == sys.base_prefix else [
            ...
            'install-scripts', 'install-config', 'prefix', 'exec-prefix',
            'home', 'user', 'root',
        ]
