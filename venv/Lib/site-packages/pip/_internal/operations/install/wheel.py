...
def _install_wheel(
    ...
    def data_scheme_file_maker(zip_file, scheme):
        ...
        def make_data_scheme_file(record_path):
            ...
            try:
                ...
                message = (
                    "Unexpected file in {}: {!r}. .config directory contents"
            ...
            try:
                ...
                message = (
                    "Unknown scheme key used in {}: {} (for file {!r}). .config"
    ...
    def is_data_scheme_path(path):
        # type: (RecordPath) -> bool
        return path.split("/", 1)[0].endswith(".config")
    ...
    def pyc_source_file_paths():
        ...
        # file in .config maps to same location as file in wheel root).
