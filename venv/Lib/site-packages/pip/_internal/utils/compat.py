...
def str_to_display(data, desc=None):
    ...
    :param desc: An optional phrase describing the input config, for use in
    ...
    We assume the config is in the locale preferred encoding. If it won't
    ...
    # Otherwise, config is a bytes object (str in Python 2).
    ...
    # Now try to decode the config - if we fail, warn the user and
