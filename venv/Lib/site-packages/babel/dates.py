...
def format_skeleton(skeleton, datetime=None, tzinfo=None, fuzzy=True, locale=LC_TIME):
    ...
    The skeletons are defined in the CLDR config and provide more flexibility
    ...
    :param skeleton: A date time skeleton as defined in the cldr config.
    ...
    for rule_id, rules in rulesets:
        for rule in rules:
            ...
            if "to" in rule and seconds_past_midnight <= rule["to"]:
                # This rule type does not exist in the present CLDR config;
