...
"""
    ...
    Locale dependent formatting and parsing of numeric config.
...
class UnknownCurrencyError(Exception):
    """Exception thrown when a currency is requested for which no config is available.
    """
...
def _format_currency_long_name(
    ...
    # locale config. So there is no point implementing that.
    # Step 2.
